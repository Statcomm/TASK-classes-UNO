...
//  * 5. (200 points) Add a method to class Card called `image()` that doesn't take any parameter, and it returns a string that represent the 
image path stored corresponding to card info
...
const greenCard = new Card(1, "Green")
const blueCard = new Card(1, "Blue")
const yellowCard = new Card(1, "Yellow")
const redCard = new Card(1, "Red")

console.log(greenCard.image())
console.log(greenCard, blueCard, yellowCard, redCard)


let cards = []
// cards.push(greenCard, blueCard, yellowCard, redCard)
for (i=1; i < 81; i++) {
  i <= 10 ? cards.push(new Card(i-1, "Green")) : 
  i <= 20 ? cards.push(new Card(i-11, "Yellow")): 
  i <= 30 ? cards.push(new Card(i-21, "Blue")) : 
  i <= 40 ? cards.push(new Card(i-31, "red")) : 
  i <= 50 ? cards.push(new Card(i-41, "Green")) : 
  i <= 60 ? cards.push(new Card(i-51, "Yellow")): 
  i <= 70 ? cards.push(new Card(i-61, "Blue")) : 
  i <= 80 ? cards.push(new Card(i-71, "red")) : 
  true
